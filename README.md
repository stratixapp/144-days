...
Since it's already deployed at `stratixapp.github.io/144-days`, just upload these files again (overwrite), then on your phone: clear site data for the page once (Chrome → ⋮ → site info → clear & reset) and reinstall so the new "144" icon replaces the old one on your home screen.
